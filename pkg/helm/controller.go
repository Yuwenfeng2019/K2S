...
import (
	...
	batchclient "github.com/Yuwenfeng2019/K2S/types/apis/batch/v1"
	coreclient "github.com/Yuwenfeng2019/K2S/types/apis/core/v1"
	k2s "github.com/Yuwenfeng2019/K2S/types/apis/k2s.cattle.io/v1"
	rbacclients "github.com/Yuwenfeng2019/K2S/types/apis/rbac.authorization.k8s.io/v1"
...
const (
	...
	label     = "helm.k2s.cattle.io/chart"
)
...
func Register(ctx context.Context) error {
	k2sClients := k2s.ClientsFrom(ctx)
	...
	h := &handler{
		...
		processor: objectset.NewProcessor("k2s.helm").
	...
	k2sClients.HelmChart.OnChange(ctx, "helm", h.onChange)
	k2sClients.HelmChart.OnRemove(ctx, "helm", h.onRemove)
...
func (h *handler) onChange(chart *k2s.HelmChart) (runtime.Object, error) {
...
func (h *handler) onRemove(chart *k2s.HelmChart) (runtime.Object, error) {
	if chart.Namespace != namespace || chart.Spec.Chart == "" {
		return chart, nil
	}
...
func job(chart *k2s.HelmChart) (*batch.Job, *core.ConfigMap) {
...
func configMap(chart *k2s.HelmChart) *core.ConfigMap {
...
func roleBinding(chart *k2s.HelmChart) *rbac.ClusterRoleBinding {
...
func serviceAccount(chart *k2s.HelmChart) *core.ServiceAccount {
...
func args(chart *k2s.HelmChart) []string {
	if chart.DeletionTimestamp != nil {
		return []string{
			"delete",
			"--purge", chart.Name,
