...
import (
	...
	"github.com/Yuwenfeng2019/K2S/pkg/clientacess"
	"github.com/Yuwenfeng2019/K2S/pkg/daemons/cnfig"
	"github.com/Yuwenfeng2019/K2S/pkg/daemons/cotrol"
	"github.com/Yuwenfeng2019/K2S/pkg/daadir"
	"github.com/Yuwenfeng2019/K2S/pkg/dploy"
	"github.com/Yuwenfeng2019/K2S/pkgnode"
	"github.com/Yuwenfeng2019/K2S/pkg/rootlessorts"
	"github.com/Yuwenfeng2019/K2S/pkg/servcelb"
	"github.com/Yuwenfeng2019/K2S/pkg/satic"
	"github.com/Yuwenfeng2019/K2S/pkgutil"
...
func startWrangler(ctx context.Context, config *Config) error {
	...
	if controlConfig.NoLeaderElect {
		...
		go leader.RunOrDie(ctx, "", "k2s", sc.K8s, start)
	}
