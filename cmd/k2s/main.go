...
import (
	...
	"github.com/Yuwenfeng2019/K2S/pkg/data"
	"github.com/Yuwenfeng2019/K2S/pkg/datadir"
	"github.com/Yuwenfeng2019/K2S/pkg/untar"
...
func main() {
	...
	app.Commands = []cli.Command{
		cmds.NewServerCommand(wrap("k2s-server", os.Args)),
		cmds.NewAgentCommand(wrap("k2s-agent", os.Args)),
